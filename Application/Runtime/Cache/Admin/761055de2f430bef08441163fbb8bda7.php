			...
			<div class="col-xs-10 col-sm-10 col-md-9 col-lg-9">
				<div class="panel panel-default">
		   			<div class="panel-body">
						...
						<div class="row">
							<form class="form-horizontal" id="article_form" role="form" method="post" action="/index.php/Admin/Article/update/id/<?php echo ($data["id"]); ?>"> 
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
								<input type="text" class="form-control" id="editor" name="editor" placeholder="请输入编辑者" value="<?php echo ($data["editor"]); ?>">
								</div>
							</div>
							<div class="form-group">
								<label for="sort" class="col-sm-2 control-label" name="sort">排序</label>
								<div class="col-sm-10">
								<input type="text" class="form-control" id="sort" name="sort" placeholder="请输入排序" value="<?php echo ($data["sort"]); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class=" col-sm-2">
									...
									<?php if(is_array($data["category"])): foreach($data["category"] as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
									</select>
								</div>
							</div>
							<div class="form-group">
...
<script type="text/javascript">
	...
	InitCategory($('#category_id')[0], "<?php echo ($data["category_id"]); ?>");
